...
const TNC_2 =
  "Aeris Beauté berkomitmen menjaga kerahasiaan data pribadi Anda dan tidak akan menyalahgunakan informasi yang Anda berikan.";
...
export function LeadForm() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    if (!acceptTerms1 || !acceptTerms2) {
      setError("Anda harus menyetujui kedua pernyataan T&C.");
      return;
    }
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <fieldset className="space-y-3 rounded-lg border border-border bg-surface-muted/60 p-4">
        ...
        <label className="flex cursor-pointer gap-3 text-sm leading-relaxed text-foreground">
          ...
          />
          <span>
            <span className="font-medium text-merlot">Opsi 1 — </span>
            {TNC_1}
          </span>
        </label>
        ...
        <label className="flex cursor-pointer gap-3 text-sm leading-relaxed text-foreground">
          ...
          />
          <span>
            <span className="font-medium text-merlot">Opsi 2 — </span>
            {TNC_2}
          </span>
        </label>
      </fieldset>
