...
export type EmailAssetUploadSlot = {
  ...
  signedUrl?: string;
  publicUrl?: string;
  /** Demo-only: client should skip storage and use a local object URL / data URL */
  demo?: boolean;
  error?: string;
};
...
/**
 * Create a signed Storage upload slot. The browser uploads the file directly
 * to Supabase (avoids Next.js "Unexpected end of form" on large Server Action bodies).
 */
